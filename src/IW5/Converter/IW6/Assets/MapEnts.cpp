...
namespace ZoneTool::IW5
{
	namespace IW6Converter
	{
		IW6::MapEnts* GenerateIW6MapEnts(MapEnts* asset, ZoneMemory* mem)
		{
			...
			iw6_asset->clientTrigger.triggerType = mem->Alloc<char>(asset->clientTrigger.numClientTriggerNodes);
			...
			iw6_asset->clientTrigger.audioTriggers = mem->Alloc<short>(asset->clientTrigger.trigger.modelCount);
			iw6_asset->clientTrigger.blendLookup = mem->Alloc<short>(asset->clientTrigger.trigger.modelCount); // todo?
			iw6_asset->clientTrigger.npcTriggers = mem->Alloc<short>(asset->clientTrigger.trigger.modelCount); // todo?
