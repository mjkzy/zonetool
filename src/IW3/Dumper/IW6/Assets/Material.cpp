...
namespace ZoneTool
{
	namespace IW6
	{
		namespace
		{
			...
			{
				{IW3::CAMERA_REGION_LIT, IW6::CAMERA_REGION_LIT_OPAQUE},
				{IW3::CAMERA_REGION_DECAL, IW6::CAMERA_REGION_LIT_TRANS},
				{IW3::CAMERA_REGION_EMISSIVE, IW6::CAMERA_REGION_EMISSIVE},
				{IW3::CAMERA_REGION_NONE, IW6::CAMERA_REGION_NONE},
			};
		...
		void dump(Material* asset)
		{
			if (asset)
			{
				...
				if (asset->techniqueSet)
				{
					...
					bool result = false;
					iw6_techset = IW6::get_iw6_techset(iw3_techset, asset->name, &result);
					if (!result)
					{
